                    ...
                    for (int u=0; u<Tilemap.m_Width; u++)
                    {
                        for (int o=0; o<Tilemap.m_Height; o++)
                        {
                            ...
                            if (index <= 133)
                            {
                                ...
                                if (index == COLFLAG_RAMP_LEFT) pTiles[tpos].m_Index = TILE_SOLID;
                                if (index == COLFLAG_RAMP_RIGHT) pTiles[tpos].m_Index = TILE_SOLID;
                                if (index == COLFLAG_ROOFSLOPE_LEFT) pTiles[tpos].m_Index = TILE_SOLID;
                                if (index == COLFLAG_ROOFSLOPE_RIGHT) pTiles[tpos].m_Index = TILE_SOLID;
