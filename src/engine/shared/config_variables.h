...
MACRO_CONFIG_STR(SvName, sv_name, 128, "Killing Floor 1.0 - Players vs. Zombies", CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, 48, 1, MAX_CLIENTS, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
